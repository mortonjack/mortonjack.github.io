...
import SudokuSmall from "@images/sudoku_small.png"
...
[I might write up a blog post explaining my process later](/blog/generating-sudokus), 
but the short version is this: use a fast solving algorithm to generate a complete board. 
